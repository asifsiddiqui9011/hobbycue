  ...
  return (
    <div className="cards-container">
      ...
      <Card.Body>
        ...
        <Card.Text style={{ fontSize:"18px",fontWeight:"300" }} >
    ...
    <Card style={{ width: '608px',padding:"40px 44px" }}>
      <Card.Body>
        ...
        <Card.Text style={{ fontSize:"18px",fontWeight:"300" }} >
        Find equipment or supplies required for your hobby.  Buy, rent or borrow from shops, online stores or from community members.        </Card.Text>
        <Button variant="outline-secondary">Get it</Button>
      </Card.Body>
    </Card>
    <Card style={{ width: '608px',padding:"40px 44px" }}>
      <Card.Body>
        ...
        <Card.Text style={{ fontSize:"18px",fontWeight:"300" }} >
        Find events, meetups and workshops related to your hobby.  Register or buy tickets online.        </Card.Text>
        <Button variant="outline-secondary">Attend</Button>
      </Card.Body>
    </Card>
    </div>
  )
